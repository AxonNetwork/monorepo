            ...
            <div className={classes.background}>
                <main className={classes.main}>
                    ...
                    <Card className={classes.card}>
                        <CardContent>
                            <form onSubmit={this.onClickSubmit} className={classes.form}>
                                <TextField
                                    label="Email"
...
const styles = (theme: Theme) => createStyles({
    ...
    main: {
        width: '100%',
        maxWidth: 1200,
        background: `linear-gradient(to right, transparent 5%, #313133 95% transparent)`,
        borderRadius: 64,
        padding: 64,
        display: 'flex',
        flexDirection: 'row',
