...
declare module 'conscience-lib/cacheHelpers' {
    ...
    export function getSecuredTextStats(repoID: string, timeline: ITimelineEvent[], filesByCommit: string[][], fromInitialCommit: boolean): ISecuredTextInfo[]
    export function getRepoMetadata(repoID: string, timeline: ITimelineEvent[], refEventsList: IRPCUpdatedRefEvent[], fromInitialCommit: boolean): IRepoMetadata
}
